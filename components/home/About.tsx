const FACTS = [
  ...
  {
    label: "Team",
    value: "Journalists, translators, commentators, designers",
  },
...
export default function About() {
  return (
    <section id="about" className="py-[120px] bg-panel border-t border-line">
      <div className="max-w-[1240px] mx-auto px-8">
        ...
        <div className="grid md:grid-cols-[1.1fr_.9fr] gap-20 items-start mt-14">
          ...
          <dl className="reveal border-l-2 border-yellow pl-7">
            {FACTS.map((fact) => (
              <div
                key={fact.label}
              ...
              >
                ...
                <dd className="text-[15px] text-paper text-right">
                  {fact.value}
                </dd>
              </div>
            ))}
